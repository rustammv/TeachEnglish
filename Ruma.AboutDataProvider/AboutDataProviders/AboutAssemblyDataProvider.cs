    ...
    public class AboutAssemblyDataProvider : IAboutDataProvider
    {
        ...
        protected virtual XmlDocument ResourceXmlDocument
        {
            get
            {
                ...
                //    // try to find it.
                //    Debug.Assert(StartUp.App.Current != null, "The current application should no tbe null at this point.");
                //    XmlDataProvider provider = StartUp.App.Current.TryFindResource(ResourceKey) as XmlDataProvider;
                //    if (provider != null)
                //    {
