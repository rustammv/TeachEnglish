    ...
    public partial class RumaMainWindow : Window, IView
    {
        ...
        public void ListAudioAddAudio(byte[] source)
        {
            this.DispatcherEx((Action)(() =>
            {
                ...
                int id = this.ListAudio.SP.Children.Count;
                ...
                this.ListAudio.SP.Children.Add(btn);
            }));
        }
        ...
        public void ListAudioClear()
        {
            this.DispatcherEx((Action)(() =>
            {
                if (this.ListAudio.SP.Children.Count > 0)
                {
                    this.ListAudio.SP.Children.Clear();
                }
        ...
        public void ListAudioProgressChanged(string text, int count, int current, long bytesReceived, long totalBytesOfReceive)
        {
            this.DispatcherEx((Action)(() =>
            {
                this.LoadingProcessAudio.LStatus.Content = text;
            }));
            ...
            if (count > 0)
            {
                this.DispatcherEx((Action)(() =>
                {
                    this.LoadingProcessAudio.PBCountFile.Maximum = count;
                    this.LoadingProcessAudio.PBCountFile.Value = current;
                    this.LoadingProcessAudio.LPBCountFile.Content = string.Format(
                        "Loaded {0} is {1} files",
                        current + 1,
                        count);
                    this.LoadingProcessAudio.PBDownloadFile.Maximum = totalBytesOfReceive;
                    this.LoadingProcessAudio.PBDownloadFile.Value = bytesReceived;
                    this.LoadingProcessAudio.LPBDownloadFile.Content = string.Format(
                        "Loaded {0} is {1} bytes",
                        bytesReceived,
                        totalBytesOfReceive);
                }));
        ...
        public void ListImageAddImage(BitmapImage bitmap)
        {
            this.DispatcherEx((Action)(() =>
            {
                int id = ListImage.SP.Children.Count;
                ...
                this.ListImage.SP.Children.Add(btn);
            }));
        }
        ...
        public void ListImageClear()
        {
            this.DispatcherEx((Action)(() =>
            {
                if (this.ListImage.SP.Children.Count > 0)
                {
                    this.ListImage.SP.Children.Clear();
                }
            }));
        }
        ...
        public void ListImageProgressChanged(string status, int current, int amount, long bytesReceived, long totalBytesOfReceive)
        {
            this.DispatcherEx((Action)(() =>
            {
                this.LoadingProcessImage.LStatus.Content = status;
            }));
            ...
            if (amount > 0)
            {
                this.DispatcherEx((Action)(() =>
                {
                    this.LoadingProcessImage.PBCountFile.Maximum = amount;
                    this.LoadingProcessImage.PBCountFile.Value = current;
                    this.LoadingProcessImage.LPBCountFile.Content = string.Format("Loaded {0} of {1} files", current, amount);
                    this.LoadingProcessImage.PBDownloadFile.Maximum = totalBytesOfReceive;
                    this.LoadingProcessImage.PBDownloadFile.Value = bytesReceived;
                    this.LoadingProcessImage.LPBDownloadFile.Content = string.Format("Loaded {0} of {1} bytes", bytesReceived, totalBytesOfReceive);
                }));
            }
        }
        ...
        public void ListTransAddTranslation(string translation, string partOfSpeach, string trancription)
        {
            this.DispatcherEx((Action)(() =>
            {
                int id = this.ListTranslation.SP.Children.Count;
                ...
                btn.Checked += (sender, args) =>
                {
                    ...
                    if (temp != null)
                    {
                        if (this.selectedTranslationID != temp.ID)
                        {
                            ...
                            foreach (ButtonImageAndCheck child in ListImage.SP.Children)
                            {
                ...
                this.ListTranslation.SP.Children.Add(btn);
            }));
        }
        ...
        public void ListTranslationClear()
        {
            this.DispatcherEx((Action)(() =>
            {
                if (this.ListTranslation.SP.Children.Count > 0)
                {
                    this.ListTranslation.SP.Children.Clear();
